 ...
 */
import { cheshireCatNotAllThereTestCase } from "@lorcanito/engine/cards/TFC/characters/green/071-cheshire-cat-not-all-there.spec";
import { teKaHeartlessTestCase } from "@lorcanito/engine/cards/TFC/characters/silver/192-te-ka-heartless.spec";
import { princePhillipTestCase } from "@lorcanito/engine/cards/TFC/characters/yellow/016-prince-phillip-dragon-slayer.spec";
