import { Table, Zones } from "~/spaces/providers/TabletopProvider";
import { makeAutoObservable, toJS } from "mobx";
import { Game } from "~/libs/game";
import { Dependencies } from "~/engine/store/types";
import { TableModel } from "~/engine/store/models/TableModel";
...
export class TableStore {
  ...
  addToInkwell(instanceId: string) {
    ...
    if (hasReachedLimit) {
      ...
      tableModel.cardsAddedToInkWellThisTurn += 1;
