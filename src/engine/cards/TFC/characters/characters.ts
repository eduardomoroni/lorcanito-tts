...
import {
  ...
  wheneverCharacterChallengesAndBanishes,
...
export const moanaOfMotunui: LorcanitoCharacterCard = {
  ...
  abilities: wheneverQuests({
    ...
    name: "WE CAN FIX IT",
    text: "**WE CAN FIX IT** Whenever this character quests, you may ready your other Princess characters. They can‘t quest for the rest of this turn.",
    // in this case if I put the ability as optional what it will mean?
    // this ability player should be able to opt-in on each character it wants to ready
    // actually I'm not sure how the opt-out here works
...
export const princePhillipDragonSlayer: LorcanitoCharacterCard = {
  ...
  type: "character",
  abilities: wheneverCharacterChallengesAndBanishes({
    name: "HEROISM",
...
export const marshmallowPersistentGuardian: LorcanitoCharacterCard = {
  ...
  type: "character",
  abilities: whenBanishedInAChallenge({
    name: "Durable",
    optional: true,
...
export const cheshireCat: LorcanitoCharacterCard = {
  ...
  type: "character",
  abilities: whenChallengedAndBanished({
    name: "Lose Something?",
...
export const teKaHeartless: LorcanitoCharacterCard = {
  ...
  type: "character",
  abilities: wheneverBanishesAnotherCharacterInChallenge({
    effects: [
      {
        type: "lore",
        amount: 2,
