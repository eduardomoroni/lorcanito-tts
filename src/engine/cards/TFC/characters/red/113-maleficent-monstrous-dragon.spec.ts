...
import {maleficentMonstrousDragon, moanaOfMotunui} from "~/engine/cards/TFC/characters/characters";
...
describe("Maleficent Monstrous Dragon", () => {
    it("**Dragon Fire** When you play this character, you may banish chosen character.", () => {
        ...
        const cardUnderTest = testStore.getByZoneAndId("hand", maleficentMonstrousDragon.id);
