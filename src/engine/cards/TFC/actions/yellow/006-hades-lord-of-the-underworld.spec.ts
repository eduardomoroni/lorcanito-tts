...
import {hadesLordOfUnderworld, ladyTremaine} from "~/engine/cards/TFC/characters/characters";
...
describe("Hades Lord of the Underworld", () => {
    it("WELL OF SOULS effect - return a character card from your discard to your hand", () => {
        ...
        const cardUnderTest = testStore.getByZoneAndId("hand", hadesLordOfUnderworld.id);
