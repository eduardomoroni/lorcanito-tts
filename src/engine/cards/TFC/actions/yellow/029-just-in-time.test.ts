...
import { justInTime } from "~/engine/cards/TFC/actions/actions";
import {captainColonelsLieutenant, teKaTheBurningOne} from "~/engine/cards/TFC/characters/characters";

describe("Just in Time", () => {
  describe("Costs <= 5", () => {
    it("Plays character card for free", () => {
