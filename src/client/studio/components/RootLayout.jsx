...
} from "@/components/RootLayoutContext";
...
function Header({
  ...
  let { logoHovered, setLogoHovered, subTitle } = useRootLayoutContext();
  ...
  return (
    <Container className="">
      <div className="flex items-center justify-between">
        ...
        <p className="inline font-display font-medium tracking-tight text-neutral-950 [text-wrap:balance]">
          <span className="text-xl sm:text-4xl">Game Lobby</span>
          <span className="text-lg sm:text-xl">{subTitle}</span>
        </p>
...
export function RootLayout({ children }) {
  ...
  return (
    <RootLayoutContext.Provider
      value={{ logoHovered, setLogoHovered, setSubTitle, subTitle }}
    >
