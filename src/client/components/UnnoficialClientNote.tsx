    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-0 px-6 pb-6">
      <div className="pointer-events-auto ml-auto max-w-xl rounded-xl bg-white p-6 shadow-lg ring-1 ring-gray-900/10">
        <p className="text-sm leading-6 text-gray-900">
          ...
          belongs to Disney®, Lorcana™, and set names are trademarks of
          Disney. Lorcana characters, cards, logos, and art are property of
          Disney. Lorcanito is not a digital gaming product.{" "}
