    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        {user ? (
          isCreating ? (
            ...
            <>
              <Button
                ...
                onClick={() => {
                  setIsCreating(true);
                  logAnalyticsEvent("game_created", { gameId: user.uid });
                }}
              >
                Create a game
              </Button>
          ...
          <Button href="/auth/signin">Create an account</Button>
        )}
        <Button href="/demo" variant="outline" legacyBehavior={false}>
          <svg
            aria-hidden="true"
          ...
          <span className="ml-3">Watch our demo</span>
        </Button>
      </div>
