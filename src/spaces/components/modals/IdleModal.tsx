...
export function IdleModal(props: Props) {
  const { onConfirm, open, timeout } = props;
  const [idle] = useSound("https://play.lorcanito.com/sounds/idle.mp3", {
    volume: 0.5,
  });
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        If you're still around, hit the confirm button. In{" "}
                        {timeout} seconds, we will disconnect you.
                      </p>
                    </div>
                  </div>
                </div>
