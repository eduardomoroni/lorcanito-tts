...
import { ContextMenuItem } from "~/spaces/providers/card-context-menu/CardContextMenu";
...
function fromHand(
  ...
  hasAddedCardToInkWellThisTurn: boolean,
...
export function createContextMenuItems(
  ...
  const hasAddedCardToInkWellThisTurn = store.tableStore
    .getTable()
    .canAddToInkwell();
